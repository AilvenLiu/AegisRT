## Chapter r01 - Session 1 - Task task-r01-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r01-build-infrastructure/INVARIANTS.md
   - agent_roadmaps/r01-build-infrastructure/ROADMAP.md
   - agent_roadmaps/r01-build-infrastructure/roadmap.yml
