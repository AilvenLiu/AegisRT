## Chapter r03 - Session 1 - Task task-r03-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r03-device-memory-pool/INVARIANTS.md
   - agent_roadmaps/r03-device-memory-pool/ROADMAP.md
   - agent_roadmaps/r03-device-memory-pool/roadmap.yml
