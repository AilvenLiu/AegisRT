## Chapter r15 - Session 1 - Task task-r15-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r15-response-time-analysis/INVARIANTS.md
   - agent_roadmaps/r15-response-time-analysis/ROADMAP.md
   - agent_roadmaps/r15-response-time-analysis/roadmap.yml
