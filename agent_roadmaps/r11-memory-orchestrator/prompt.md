## Chapter r11 - Session 1 - Task task-r11-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r11-memory-orchestrator/INVARIANTS.md
   - agent_roadmaps/r11-memory-orchestrator/ROADMAP.md
   - agent_roadmaps/r11-memory-orchestrator/roadmap.yml
