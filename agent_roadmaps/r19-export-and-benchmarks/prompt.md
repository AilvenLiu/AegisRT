## Chapter r19 - Session 1 - Task task-r19-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r19-export-and-benchmarks/INVARIANTS.md
   - agent_roadmaps/r19-export-and-benchmarks/ROADMAP.md
   - agent_roadmaps/r19-export-and-benchmarks/roadmap.yml
