# INVARIANTS -- Constitutional Constraints for r19-export-and-benchmarks
...
## 5. Roadmap-Specific Invariants (r19)

- Perfetto export MUST produce valid Perfetto JSON (loadable in chrome://tracing).
- Determinism benchmark MUST be automated and run in CI.
- CV < 5% MUST be asserted (not just measured) in the benchmark.
- All 4 MVP validation scenarios MUST be covered by case studies.
- Case study results MUST use actual measured numbers (not estimates).
