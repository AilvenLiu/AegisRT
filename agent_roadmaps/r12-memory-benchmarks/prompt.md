## Chapter r12 - Session 1 - Task task-r12-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r12-memory-benchmarks/INVARIANTS.md
   - agent_roadmaps/r12-memory-benchmarks/ROADMAP.md
   - agent_roadmaps/r12-memory-benchmarks/roadmap.yml
