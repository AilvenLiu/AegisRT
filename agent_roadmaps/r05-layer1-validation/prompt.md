## Chapter r05 - Session 1 - Task task-r05-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r05-layer1-validation/INVARIANTS.md
   - agent_roadmaps/r05-layer1-validation/ROADMAP.md
   - agent_roadmaps/r05-layer1-validation/roadmap.yml
