# INVARIANTS -- Constitutional Constraints for r05-layer1-validation
...
## 5. Roadmap-Specific Invariants (r05)

- Coverage MUST exceed 70% for every Layer 1 source file individually (not just aggregate).
- cuda-memcheck MUST report zero leaks and zero errors.
- ASan MUST report zero errors.
- Cross-compilation MUST succeed without errors or warnings.
- All public APIs MUST have Doxygen @brief, @param, @return comments.
- This roadmap MUST NOT add new features -- validation only.
