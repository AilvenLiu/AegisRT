## Chapter r16 - Session 1 - Task task-r16-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r16-scheduling-policies/INVARIANTS.md
   - agent_roadmaps/r16-scheduling-policies/ROADMAP.md
   - agent_roadmaps/r16-scheduling-policies/roadmap.yml
