## Chapter r17 - Session 1 - Task task-r17-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r17-scheduler-core/INVARIANTS.md
   - agent_roadmaps/r17-scheduler-core/ROADMAP.md
   - agent_roadmaps/r17-scheduler-core/roadmap.yml
