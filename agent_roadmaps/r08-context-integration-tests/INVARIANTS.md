# INVARIANTS -- Constitutional Constraints for r08-context-integration-tests
...
## 5. Roadmap-Specific Invariants (r08)

- This roadmap MUST NOT add new production code (tests only).
- All integration tests MUST use MockBackend (no real inference engines).
- Concurrent tests MUST use ThreadSanitizer (TSan) to detect data races.
- Coverage MUST exceed 70% for every src/context/ source file individually.
