## Chapter r10 - Session 1 - Task task-r10-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r10-memory-planner/INVARIANTS.md
   - agent_roadmaps/r10-memory-planner/ROADMAP.md
   - agent_roadmaps/r10-memory-planner/roadmap.yml
