## Chapter r20 - Session 1 - Task task-r20-0
...
1. Read and obey:
   ...
   - agent_roadmaps/r20-documentation/INVARIANTS.md
   - agent_roadmaps/r20-documentation/ROADMAP.md
   - agent_roadmaps/r20-documentation/roadmap.yml
